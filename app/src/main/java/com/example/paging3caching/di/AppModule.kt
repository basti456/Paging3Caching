package com.example.paging3caching.di
...
import com.example.paging3caching.data.remote.BeerApi
import com.example.paging3caching.data.remote.BeerRemoteMediator
...
object AppModule {
    ...
    fun provideBeerApi(): BeerApi {
        return Retrofit.Builder().baseUrl(BeerApi.BASE_URL).addConverterFactory(
